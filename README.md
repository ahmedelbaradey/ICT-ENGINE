...
| **2 — ICT engine** | 🔵 **In progress — R2-01…R2-05.9 done (sessions, swings, structure, liquidity, FVG, true daily open, IFVG, order blocks, breakers, BPR, RDRB, CISD, Unicorn). R2-06 premium/discount is next.** |
| 3 — Feature dataset | ⬜ |
| 4 — Baseline models | ⬜ |
